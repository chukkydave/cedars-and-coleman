...
$(document).ready(function() {
	var $buythemediv =
		'<div class="buy-theme xs-display-none"><a href="https://1.envato.market/ryZWR" target="_blank"><span>Purchase Theme</span></a></div><div class="quick-question xs-display-none"><a href="mailto:info@themezaa.com?subject=H-Code Quick Question"><span>Quick Question?</span></a></div>';
	...
	if (!isMobile) {
		jQuery('.top-cart a.shopping-cart, .cart-content').hover(
			function() {
	...
	if (location.hash != '') {
		...
		$portfolio_selectors.each(function() {
			if ($(this).attr('data-filter') == temphashfilter) {
				...
				$portfolio_selectors_li
					.find('a[data-filter="' + temphashfilter + '"]')
					.parent('li')
					.addClass('active');
	...
	$('form.search-form, form.search-form-result').submit(function(event) {
		...
		if (error) {
			...
			action =
					...
					action == '#' || action == '' ? 'blog-grid-3columns.html' :
					action;
...
/*==============================================================*/
$('#counter-underconstruction')
	.countdown('2016/12/15 12:00:00')
...
$('#counter-underconstruction2')
	.countdown('2017/03/15 12:00:00')
	.on('update.countdown', function(event) {
		var $this = $(this).html(
			event.strftime(
				'' +
